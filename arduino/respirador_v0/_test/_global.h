...
//#define SIMULADOR
// Habilitar para iniciar com um modo pré-determinado
...
struct DadosTesteUnitario
{
  float tensaoFonte;
  float tensaoBateria;
  float pressaoAr;
  float pressaoO2;
  bool erroTimeoutPressao[3];
  bool erroTimeoutFluxo[4];
  bool erroOffsetPressao[3];
  bool erroOffsetFluxo[4];
  int minPwmValvulasAOP[3];
  int maxPwmValvulasAOP[3];
  int minSaidaValvulasAOP[3];
  int maxSaidaValvulasAOP[3];
  long minAdcSensoresFluxo[3];
  long maxAdcSensoresFluxo[3];
  int minPilotoCurvaSis;
  int maxPilotoCurvaSis;
  int minPressaoSis;
  int maxPressaoSis;
  int tempoValvulaSeg;
  float vazamentoCircuitPac;
};
...
// mocks para teste
extern int ensaioTempoValvulaSeg;
extern float ensaioVazamentoCircuitoPac;
...
extern DadosTesteUnitario dadosTeste;
