...
#define REG_CONFIG_OM_MASK 0x18 // inclui para o turbo
...
class ADS1220
{
  ...
  public:
    ...
    void set_op_turbo(); // inclui para o turbo
    bool getTimeOutFlag(void); // verifica timeout da conversao
